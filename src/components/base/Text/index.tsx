import {FontHelveticaNeue} from 'assets';
...
export type TextProps = RNTextProps &
  Partial<{
    ...
    color: ColorValue;
    fontSize: number;
    font: keyof typeof FontHelveticaNeue;
...
export const Text = ({
  ...
  const _style = [
    {
      ...
      fontFamily: FontHelveticaNeue[font],
    },
  ...
  return (
    <RNText maxFontSizeMultiplier={1.2} {...props} style={_style}>
      {children}
    </RNText>
  );
};
